...
public:
  ...
  bool applyMod(const std::string &modName_);
  bool applyModsList(std::vector<std::string>& modsList_);
  bool removeMod(const std::string &modName_);
...
protected:
  ...
  bool removeModInstalledFiles(const std::string &modName_, bool forceUnknownInstalledFiles_);
  ...
  void finalizeModFilesystemChanges(const std::string& title_);
